...
public class DESalgorithm {
	...
	public int[] PC1(int[] keyblock) {
		...
		int index = 0;
		int[] refPC1 = { 57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18,
	...
	public int[] InitialPerm(int[] datablock) {
		...
		int[] refIP = { 58, 50, 42, 34, 26, 18, 10, 2, 60, 52, 44, 36, 28, 20,
	...
	public void keyGenerator(int[] initkey, char ED) {
		int shiftblock[][] = { { 1, 1 }, { 2, 1 }, { 3, 2 }, { 4, 2 },
				{ 5, 2 }, { 6, 2 }, { 7, 2 }, { 8, 2 }, { 9, 1 }, { 10, 2 },
	...
	public int[] Etable(int[] rblock) {
		int index;
		int[] etableret = new int[48];
		int[] refEtable = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7, 8, 9, 8, 9, 10, 11,
	...
	public int[] PC2(int[] key) {
		...
		int[] refPC2 = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19,
	...
	// This routine parses the 48-bit input block to 8 S-boxes, each S-box takes
	// 6-bit input returning 4-bit output.
	...
	// This method acts as a subroutine for the S-box, calculating the S-box row
	// and column from the 6-bit input.
	...
	public int[] Permutation(int[] sbox) {
		int index;
		int[] sboxret = new int[32];
		int[] refPermutation = { 16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26,
	...
	public int[] InitialPermInv(int[] datablock) {
		...
		int[] refIPInv = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55,
